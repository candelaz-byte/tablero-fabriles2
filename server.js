...
// CORS: permite que el HTML descargable consuma la API desde cualquier origen
...
app.get('/costo-tn', (req, res) => res.sendFile(path.join(__dirname, 'tablero_dh_v2.html')));
